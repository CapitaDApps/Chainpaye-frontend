  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-[400px] mx-auto text-center py-8">
      ...
      <p className="text-gray-600 mb-6 leading-relaxed">
        We're verifying your payment with the bank. This usually takes a few
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 w-full">
        ...
        <p className="text-xs text-yellow-700 mt-1">
          Most payments confirm within 15 minutes. If not confirmed within 24
          hours, we'll send you an update.
        </p>
      </div>
