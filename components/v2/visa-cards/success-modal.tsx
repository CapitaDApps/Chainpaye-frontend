...
export function SuccessModal({ isOpen, onClose }: SuccessModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-lg bg-white rounded-3xl p-8 shadow-2xl animate-in fade-in zoom-in duration-300 text-center">
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col items-center justify-center py-8">
          <h3 className="text-xl font-bold text-[#111528] mb-2">
            <span className="text-4xl mb-6">🎉</span>Request Received!
          </h3>

          <p className="text-xl font-medium text-[#5A5F73] mb-8">
