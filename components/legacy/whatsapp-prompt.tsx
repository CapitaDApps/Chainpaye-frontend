      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center gap-16 max-w-6xl mx-auto">
          ...
          <div className="relative w-full max-w-sm mx-auto md:mx-0">
            <div className="relative aspect-[9/19] rounded-[3rem] border-8 border-zinc-900 bg-zinc-900 overflow-hidden shadow-2xl">
              ...
              <div className="h-full w-full bg-white flex flex-col">
                ...
                {/* Chat area */}
                <div className="flex-1 p-4 bg-[#ece5dd] space-y-4 overflow-hidden">
                  <div className="bg-white p-3 rounded-tr-lg rounded-br-lg rounded-bl-lg max-w-[80%] text-sm shadow-sm">
                    Hi! 👋 I can help you send money.
                  </div>
                  <div className="bg-[#dcf8c6] p-3 rounded-tl-lg rounded-bl-lg rounded-br-lg max-w-[80%] ml-auto text-sm shadow-sm">
                    Send $50 to @john
                  </div>
                  <div className="bg-white p-3 rounded-tr-lg rounded-br-lg rounded-bl-lg max-w-[80%] text-sm shadow-sm">
          ...
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-3xl font-bold tracking-tight text-zinc-900 md:text-5xl mb-6">
              Send and receive Money <br /> instantly on Whatsapp
            </h2>
            <p className="text-lg text-zinc-600 mb-8 max-w-lg mx-auto md:mx-0">
