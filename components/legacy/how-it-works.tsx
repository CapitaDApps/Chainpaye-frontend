        ...
        <div className="flex flex-col gap-24 max-w-6xl mx-auto">
          {steps.map((step, index) => (
            ...
            >
                    ...
                    (sentence, i) =>
                      sentence && (
                        <li key={i} className="flex gap-3">
                          <span className="flex-shrink-0 mt-1 flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-600 text-xs font-bold">
                            {i + 1}
                          </span>
                          <span>{sentence}.</span>
                        </li>
              ...
              <div
                className={`flex-1 w-full aspect-[4/3] rounded-3xl ${step.imageParams} flex items-center justify-center relative overflow-hidden border border-zinc-100`}
              >
                <step.icon className="w-32 h-32 text-zinc-300 opacity-50" />
