  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden pt-24 pb-12 px-4 md:pt-32">
      ...
      */}
      ...
      <div className="absolute inset-0 -z-20 bg-gradient-to-tr from-blue-50 to-white opacity-40"></div>
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none z-10 max-w-7xl mx-auto hidden lg:block">
        ...
        <div className="absolute top-[55%] left-[5%] transform -translate-y-1/2 pointer-events-auto">
          <div className="bg-white p-6 rounded-2xl shadow-xl max-w-[260px] hover:scale-105 transition-transform duration-300 -rotate-3 hover:rotate-0 border border-zinc-100">
            <div className="mb-4">
              <Plug className="h-8 w-8 text-zinc-900" />
            </div>
        ...
        <div className="absolute top-[55%] right-[5%] transform -translate-y-1/2 pointer-events-auto">
          <div className="bg-white p-6 rounded-2xl shadow-xl max-w-[260px] hover:scale-105 transition-transform duration-300 rotate-3 hover:rotate-0 border border-zinc-100 relative">
            <div className="mb-4">
      ...
      <div className="container relative mx-auto text-center z-10 max-w-4xl mt-12 lg:mt-0">
        <h1 className="mb-6 text-5xl font-bold leading-tight tracking-tight text-[#111528] md:text-7xl">
          Empowering businesses <br /> and individuals to collect <br />
          payments globally
        </h1>
        <p className="mb-8 text-lg text-[#5A5F73] md:text-xl max-w-2xl mx-auto">
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="relative w-full h-full max-w-[900px] max-h-[450px]">
        {/* Locations */}
        {/* USA */}
        <div className="absolute top-[22%] -left-[12%] w-10 h-10 md:w-14 md:h-14 bg-white shadow-lg p-2 md:p-3 flex items-center justify-center z-10 transition-transform hover:scale-110">
          <Image
            src="/assets/us.png"
            alt="USA"
            width={32}
        ...
        {/* UK */}
        <div className="absolute top-[18%] left-[53%] w-10 h-10 md:w-14 md:h-14 bg-white shadow-lg p-2 md:p-3 flex items-center justify-center z-10 transition-transform hover:scale-110">
          <Image
            src="/assets/uk.png"
            alt="UK"
            width={32}
        ...
        {/* Nigeria */}
        <div className="absolute top-[62%] left-[46%] w-10 h-10 md:w-14 md:h-14 bg-white shadow-lg p-2 md:p-3 flex items-center justify-center z-10 transition-transform hover:scale-110">
          <Image
            src="/assets/ng.png"
            alt="Nigeria"
            width={32}
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl p-4 flex items-start gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 whitespace-nowrap min-w-max">
            {/* Icon Box */}
            <div className="h-10 w-10 rounded-xl bg-zinc-100 flex items-center justify-center text-blue-600 shrink-0 relative">
