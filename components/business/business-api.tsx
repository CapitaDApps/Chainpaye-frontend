  ...
  return (
    <section className="px-4  overflow-hidden">
      <div className="container mx-auto">
        <h2 className="text-3xl md:text-[40px] font-medium text-[#111528] mb-12 max-w-md">
          Get ready to scale with our payment APIs
        </h2>

        <div className="bg-[#E8EDFF] md:h-[600px] rounded-2xl flex flex-col md:flex-row items-center justify-between p-8 md:p-16 gap-12 md:gap-20">
          {/* Left Side: Features list */}
          <div className="w-full md:w-5/12 space-y-8">
            <div className="flex items-center gap-4">
              <Settings/>
              <span className="text-[#111528] font-medium text-2xl md:text-xl ">Quick setup, easy integration</span>
            </div>
            <div className="flex items-center gap-4">
              <Braces className="w-6 h-6 text-[#10B981]" />
              <span className="text-[#111528] font-medium text-2xl md:text-xl ">Flexible APIs for any payment use case</span>
            </div>
            <div className="flex items-center gap-4">
              <Clock/>
              {/* <Clock className="w-6 h-6 text-[#F59E0B]" /> */}
              <span className="text-[#111528] font-medium md:text-xl text-lg">Production-ready in under 30 minutes</span>
            </div>
